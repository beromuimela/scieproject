 ...
 * @author junito
 */
public class UtilizadorForm extends javax.swing.JDialog {
    private Principal pai;
    private UtilizadorControladora listener;
    /**
     * Creates new form Utilizador
     */
    public UtilizadorForm(Principal parent, boolean modal) {
        super(parent,modal);
        initComponents();
        listener=new UtilizadorControladora(this);
        setLocationRelativeTo(parent.getjDesktopPane1());
    }
    
    public UtilizadorForm(JDialog parent, boolean modal) {
        super(parent,modal);
        initComponents();
        listener=new UtilizadorControladora(this);
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jtEstado, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jLabel17.setText("Fecho de caixa");
        ...
        jTabbedPane2.addTab("Configuracoes", jPanel8);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UtilizadorForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UtilizadorForm().setVisible(true);
