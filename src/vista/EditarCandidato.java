 ...
 * @author junito
 */
public class EditarCandidato extends javax.swing.JDialog {

    private ControleCandidatos pai;
    private Candidato candidato;
    private EditarCandidatoControladora listener;
    ...
    public EditarCandidato(ControleCandidatos pai, boolean modal,Candidato candidato) {
        super(pai,modal);
        this.candidato=candidato;
        initComponents();
        listener=new EditarCandidatoControladora(this);
        setLocationRelativeTo(pai);
        
        //modar pelo icone da gajm
        URL url=getClass().getResource("/icones/ajuda.png");
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addComponent(modeloPagamento, 0, 243, Short.MAX_VALUE)
        );
        ...
        jTabbedPane1.addTab("EDITAR CANDIDATO", jPanel2);
        ...
        Eliminar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/user_delete.png"))); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(ButtonFechar)
                    .addComponent(ButtonSalvar)
                    .addComponent(Eliminar, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(18, Short.MAX_VALUE))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarCandidato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarCandidato().setVisible(true);
            }
        });
    }
