...
import Controladora.EditarFormadorControladora;
 ...
 * @author junito
 */
public class EditarFormador extends javax.swing.JDialog {
    private EditarFormadorControladora listener;
    private Formador formador;    
    /**
     * Creates new form FormadorForm
     */
    public EditarFormador(JDialog parent, boolean modal,Formador formador) {
        super(parent, modal);
        this.formador=formador;
        initComponents();
        this.listener=new EditarFormadorControladora(this);
        setLocationRelativeTo(parent);
    }

    public EditarFormador() {
    }
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("EDITAR FORMADOR", jPanel2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarFormador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditarFormador dialog = new EditarFormador(new javax.swing.JDialog(), true,new entidades.Formador());
