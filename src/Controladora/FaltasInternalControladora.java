 ...
 * @author junito
 */
public class FaltasInternalControladora implements ActionListener, ItemListener {

    private final FaltasInternal form;
    ...
    public FaltasInternalControladora(FaltasInternal form) {
        this.form = form;
        this.colunas = new String[]{"Nr", "Nome Completo", "Sexo", "Faltas"};
    ...
    public void adicionaDatas(Nome_periodo nomeperiodo) {
        ...
        if (!datas.isEmpty()) {
            ...
            form.setListaDestudantes(Lista);
            data = new Date();
        }
    }
    ...
    public final void preencherTable(List<Estudante_Pacotes> estudantes) {
        ...
        if (estudantes.isEmpty()) {
            ...
            for (int i = 0; i < linha; i++) {
                ...
                estudanteModel.setValueAt(estudantes.get(i).getNumerofaltas(), i, 3);
            }
