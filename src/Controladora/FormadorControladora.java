 ...
 * @author junito
 */
public class FormadorControladora implements ActionListener,ItemListener {

    private final FormadorForm form;
    ...
    public FormadorControladora(FormadorForm form) {
        this.form = form;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals("fechar")) {
            ...
            if (f.getNome() != null && f.getEmail() != null && f.getMorada() != null && f.getTelefone() != null && f.getDatanascimento() != null) {
                if (servico.Existe(f)) {
                    JOptionPane.showMessageDialog(form, "Este formador ja existe!", "Erro", JOptionPane.ERROR_MESSAGE);
                } else {
                    servico.salvar(f);
                    JOptionPane.showMessageDialog(form, "Formador cadastrado com sucesso!", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
                    limparCampos();
